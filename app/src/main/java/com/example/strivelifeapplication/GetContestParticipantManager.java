...
public class GetContestParticipantManager {
    private JSONArray result_arr;
    private String result;

    public JSONArray getContestParticipant(String contest_name){
    ...
    private class GetContestParticipantRunnable implements Runnable {
