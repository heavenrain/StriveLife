...
public class UpdateavatarManager {
    private JSONArray result_arr;
    private String result;


    public JSONArray updateAvatar(String username, String avatar){
        UpdateAvatarRunnable UpdateAvatar = new UpdateAvatarRunnable();
        UpdateAvatar.setParams(username, avatar);
        Thread thread = new Thread(UpdateAvatar);
        thread.start();
        try {
            thread.join();
    ...
    public class UpdateAvatarRunnable implements Runnable {
        private String username;
        private String avatar;

        public void setParams(String username, String avatar) {
        ...
        public void run() {
            try {
                URL url = new URL("http://140.116.82.9:9000/updateAvatar.php");
